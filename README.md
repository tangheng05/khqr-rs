...
<img src="docs/example-qr.png" alt="A KHQR code generated by this library" width="200" align="right">

A static QR for a shop, generated by `khqr gen` and checked against the four
published test vectors. Point a banking app at it and you will see the
merchant name and city read back.
